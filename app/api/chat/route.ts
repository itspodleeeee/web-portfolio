...
- if user asks about resume or relate to it, provide the file link so the user can download it and provide a brief overview of its contents based on the CONTEXT, but do not go into specific details that are not included in the CONTEXT. Always include the line about contacting John for more details if they want to learn more about his resume or specific experience and skills listed in it.
`.trim();
